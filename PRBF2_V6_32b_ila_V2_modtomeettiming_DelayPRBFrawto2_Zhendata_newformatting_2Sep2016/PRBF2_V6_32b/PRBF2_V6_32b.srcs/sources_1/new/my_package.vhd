...
type counter_ar is array (1 to 40) of std_logic_vector(7 downto 0);
...
type modid_ar is array (1 to 40) of std_logic_vector(8 downto 0);
...
type PRBF1_from_BP_ar is array(1 to 7) of std_logic_vector(31 downto 0);
...
----MT official format
type serial_layer_ar is array (1 to 40) of std_logic_vector(34 downto 0);

--type serial_layer_ar_out is array (1 to 8) of std_logic_vector(27 downto 0); --
-- MT official format
type serial_layer_ar_out is array (1 to 8) of std_logic_vector(34 downto 0);
...
type data_p_ar is array (1 to 40) of std_logic_vector(511 downto 0);
...
type data_itimeslayer_ar is array (1 to 6) of data_i_ar;
type vec16_timeslayer_ar is array (1 to 6) of std_logic_vector(1 to 16);
type vec7_timeslayer_ar is array (1 to 6) of std_logic_vector(7 downto 0);
type vec4_timeslayer_ar is array (1 to 6) of std_logic_vector(4 downto 0);
type vec4_times40mod_ar is array (1 to 40) of std_logic_vector(3 downto 0);
type vec8_times40mod_ar is array (1 to 40) of std_logic_vector(8 downto 0);
type vec2_times16_ar is array (1 to 16) of std_logic_vector(1 downto 0);
type vec2_times16_timeslayer_ar is array (1 to 6) of vec2_times16_ar;


type data_count_fifo_ar is array(1 to 16) of std_logic_vector(7 downto 0);
type data_count_fifo_timeslayer_ar is array(1 to 6) of data_count_fifo_ar;

type vec2_timeslayer_ar is array (1 to 6) of std_logic_vector(1 downto 0); 
end my_package;
